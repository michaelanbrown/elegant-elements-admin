    ...
    <div className="App">  
      ...
      <Header />
        <Routes>
          ...
          <Route path="/login" element={<Login getCategories={getCategories} getProducts={getProducts} getUsers={getUsers}/>} />
          <Route path="/signup" element={<Signup users={users} setUsers={setUsers} getCategories={getCategories} getProducts={getProducts} getUsers={getUsers}/>} />
